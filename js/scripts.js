...
var loadSVGs = function(){
	$('.behance').load('svg/behance.svg',function(response, status, xhr){
		callback(response, status, xhr);
	});
	$('.github').load('svg/gitHub.svg',function(response, status, xhr){
		callback(response, status, xhr);
	});
	$('.code-shield').load('svg/code-shield.svg',function(response, status, xhr){
		callback(response, status, xhr);
	});
	$('.design-shield').load('svg/design-shield.svg',function(response, status, xhr){
		callback(response, status, xhr);
	});
	$('.svg-container , .inner').load('svg/svg_logo_simple.svg',function(response, status, xhr){
		callback(response, status, xhr);
	});
	$('.badge').load('svg/badge.svg',function(response, status, xhr){
		callback(response, status, xhr);
	});
}
